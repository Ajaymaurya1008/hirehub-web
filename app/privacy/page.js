        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-base text-black sm:text-xl">
                HireHub follows a standard procedure of using log files. These
              ...
              <p className="mt-4 text-base text-black sm:text-xl">
                Like any other website, HireHub uses cookies. These cookies are
              ...
              <p className="mt-4 text-base text-black sm:text-xl">
                For more detailed information on cookies, please refer to the
                cookies section of our websites.
              </p>
              <h2 className="mt-8 text-2xl font-bold text-black sm:text-3xl lg:text-4xl">
